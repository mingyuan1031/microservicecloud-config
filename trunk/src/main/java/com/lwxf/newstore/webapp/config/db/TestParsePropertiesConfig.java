...
@Configuration
@Profile("test")
public class TestParsePropertiesConfig {
	@Bean
	public static PropertyPlaceholderConfigurer encryptionPropertyPlaceholderConfigurer(){
		...
		bean.setLocations(new ClassPathResource("application.properties"),new ClassPathResource("application-test.properties"));
		return bean;
	}
}
