...
<script>
	  ...
	  import axios from 'axios'
       ...
       var _this = this
			...
			this.numBer=cfg.preload.reservations || 0;
...
.yuyueLibutton span{display: block;  background-color: #d82626; font-size: 0.9rem; color: white; text-align: center; height: 2.2rem; line-height: 2.2rem;  width: 100%;}
