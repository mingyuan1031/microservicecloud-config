	...
	<div id="share" style="background: #EEEEEE;" class="paddingBox">
		...
		<!--	<div class="imgMagnify" :class="{open_block:alertopen==true}" @click="imgNone"> 
				...
				<div class="imgNav">
					...
					<div class="swiper-container snot" style="background: black;">
...
//             /this.caselist = this.datas[index].files
        ...
        //显示快享点赞人昵称
         nameshow:function  (e) {
         	...
         	/*	var divname = document.querySelector(".praiseitemul");
              var getli = divname.querySelectorAll('li');
              
              for(var i=0; i<getli.length; i++){
              	getli[i].classList.remove("nameshow")
              }
              
              if(this.nameshowtype==true){
