	...
	export default {
		...
		mounted: function() {
			...
			_this.axios({
				...
				_this.mergername=res.data.data.receiverAddress.split('-')[0]
				_this.defaulted = res.data.data.defaulted
				_this.msg.name = res.data.data.receiver
				_this.msg.phone = res.data.data.receiverPhone
				_this.msg.detailed = res.data.data.receiverAddress.split('-')[1]
