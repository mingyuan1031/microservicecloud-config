<template>
	<div class="error_404">
		<ul>
		<li class="error_son"><img src="../../assets/img/WiFi.png" /></li>
		<li class="error_son1">哎呀...网络似乎断开啦</li>
		<li class="error_son2"> <div class="back_404">返回首页</div></li>
		</ul>
	</div>
</template>
...
<style>
	*{margin:0; padding:0; border:0; font-family:"微软雅黑";}
            ...
            .error_son{width:32%; margin: auto; display: block;}
